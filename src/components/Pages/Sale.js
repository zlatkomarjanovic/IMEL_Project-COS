...
const Women = () => {
    return (
        <div className = "overlapping_container">
           ...
           <div>
            <img src = "https://ae01.alicdn.com/kf/HTB175NPax_rK1RkHFqDq6yJAFXaB/Long-Slim-Blend-Outerwear-2019-Women-Overcoat-Wool-Coat-Autumn-Winter-Jacket-Clothes.jpg_960x960.jpg" /> 
            <img src = "https://res.cloudinary.com/webstore/image/fetch/w_450,c_limit,c_fit,f_auto,e_trim/https%3A%2F%2Fae01.alicdn.com%2Fkf%2FH4d35a363fd844fa5aeb5a481ce51f1090%2F2020-Autumn-And-Winter-Solid-Windbreaker-Jacket-2020-New-Men-Coat-Fashion-Long-Trench-Coats-Lapel.jpg" /> 
           </div>
        </div>
    )
}
